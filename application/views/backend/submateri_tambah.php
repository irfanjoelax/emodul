                ...
                <div class="col-12">
                    <div class="card shadow mb-4">
                        <div class="card-header bg-success py-3">
                            <h6 class="m-0 font-weight-bold text-white">Tambah Data Submateri</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="<?= site_url('submateri/jalankan/tambah') ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="txt_mtr" id="txt_mtr" class="form-control form-control-sm">
                                                    ...
                                                    <option value="<?= $mtri->idmtr ?>"><?= $mtri->namamtr ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
...
<!-- custom javascript -->
<script src="<?= base_url('backend/script/validasi_tambah_submateri.js') ?>"></script>
<script>
